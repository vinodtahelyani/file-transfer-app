            ...
            try {
                ...
                if (initilize[0] == 2) {
                    ...
                    switch (Integer.parseInt(new String(cmd_buff))) {
                        case 124:
                            rw = new RandomAccessFile("C:\\Users\\Vinod Tahelyani\\Downloads\\" + new String(recv_data), "rw");
                        ...
                        case 126:
                            ...
                            System.out.println(current_file_pointer+"**");
                            dout.write(CreateDataPacket("125".getBytes("UTF8"), String.valueOf(current_file_pointer).getBytes("UTF8")));
                            dout.flush();
                            if(len==current_file_pointer){
                                flag=false;
                                break;
                            }
                            break;
